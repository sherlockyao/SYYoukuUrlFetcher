...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "A short description of SYYoukuUrlFetcher."
  s.description      = <<-DESC
                       ...
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/SYYoukuUrlFetcher"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Sherlock Yao" => "yaosherlock@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/SYYoukuUrlFetcher.git", :tag => s.version.to_s }
